...
/**
 * Protected Links en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('protected-links', '...')`) as
 ...
 */
return [
    'Protected Links plugin loaded' => 'Protected Links plugin loaded',
];
